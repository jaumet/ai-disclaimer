...
${imageHtml}
  ...
  if (maker) {
    ...
    function updateMaker() {
      ...
      const compactHtml = `<div class="aiud-widget" style="position:relative;display:inline-block;color:#0d0e37;font:14px/1.4 system-ui,sans-serif">\n  <style>\n    @keyframes aiud-nudge{0%,100%{transform:translateY(0) rotate(3deg)}50%{transform:translateY(-3px) rotate(3deg)}}\n    .aiud-widget .aiud-ribbon{position:absolute;z-index:2;right:-12px;top:-13px;padding:4px 9px;border-radius:999px;background:#f7836a;color:#0d0e37;font-size:9px;font-weight:900;letter-spacing:.08em;box-shadow:0 4px 10px #0d0e3730;animation:aiud-nudge 1.4s ease-in-out infinite;pointer-events:none}\n    .aiud-widget .aiud-details{position:absolute;z-index:2147483647;left:0;bottom:calc(100% + 9px);visibility:hidden;opacity:0;transform:translateY(5px);width:min(370px,90vw);box-sizing:border-box;padding:15px;border:1px solid #d5d5dc;border-radius:11px;background:#fff;box-shadow:0 18px 45px #0d0e3728;transition:.18s ease;pointer-events:none}\n    .aiud-widget:hover .aiud-details,.aiud-widget:focus-within .aiud-details{visibility:visible;opacity:1;transform:none;pointer-events:auto}\n    @media(prefers-reduced-motion:reduce){.aiud-widget .aiud-ribbon{animation:none}}\n  </style>\n  <button type="button" aria-describedby="aiud-details" style="position:relative;display:flex;align-items:center;gap:9px;width:max-content;max-width:100%;padding:7px 10px 7px 7px;border:1px solid #d5d5dc;border-radius:8px;background:#fff;color:#0d0e37;font:inherit;text-align:left;cursor:pointer;box-shadow:0 4px 12px #0d0e3712">\n    <span class="aiud-ribbon" aria-hidden="true">HOVER / TAP</span>\n    <span style="width:42px;height:42px;flex:0 0 42px;overflow:hidden;border-radius:50%"><img src="https://ai.selectora.cc/static/images/ai-use-declared-logo.png" alt="" style="display:block;width:100%;height:100%;object-fit:cover"></span>\n    <strong style="letter-spacing:.03em">AI USE DECLARED<small style="display:block;color:#66677d;font-size:10px;letter-spacing:0">See how this site uses AI</small></strong>\n  </button>\n  <div class="aiud-details" id="aiud-details" role="tooltip">\n    <p style="margin:0 0 10px"><strong>This site</strong> declares its use of AI as:</p>\n    <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:5px">\n${compactImages}\n    </div>\n    <a href="https://ai.selectora.cc/badges/" target="_blank" rel="noopener" style="display:block;margin-top:10px;color:#0d0e37;font-size:11px;font-weight:800">What does this mean? →</a>\n  </div>\n</div>`;
