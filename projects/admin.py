...
class AdhesionAdmin(admin.ModelAdmin):
    list_display = ("full_name", "email", "supporter_type", "organization_name", "display_publicly", "created_at")
    list_filter = ("supporter_type", "display_publicly", "pledge_version")
    search_fields = ("full_name", "email", "organization_name")
    readonly_fields = ("pledge_version", "created_at")
